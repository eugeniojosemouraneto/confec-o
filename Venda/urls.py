...
urlpatterns = [
    ...
    path('Alterar/Produto-Base/<int:id_product_base>/', views.Modify_product_Base, name = "Modify-Product-Base"),    path('Alterar/Produto/<int:id_product>/', views.Modify_product, name = "Modify-Product"),
